...
from maria.errors import NoSuitablePlansError
...
def test_planner():
    ...
    planner = Planner(target=input_map, site="green_bank", constraints={"el": (70, 90), "hour": (14, 15)})
