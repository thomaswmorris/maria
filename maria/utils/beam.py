...
def gaussian_beam_angular_fwhm(z, w_0, n=1, f=None, l=None):
    """
    Returns the angular full width at half maximum of a Gaussian beam with waist `w_0` at distance `z` in refractive index `n`.
    Supply either the wavelength `l` or the frequency  `f`.
    ...
    """
    l = l if l is not None else 2.998e8 / f
...
def gaussian_beam_physical_fwhm(z, w_0, n=1, f=None, l=None):
    return z * gaussian_beam_angular_fwhm(z=z, w_0=w_0, n=n, f=f, l=l)
